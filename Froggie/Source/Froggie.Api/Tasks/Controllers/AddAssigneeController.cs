...
public sealed record AddAssigneeRequest(
    [Required] Guid TaskId,
    [Required] Guid UserId);

public sealed class AddAssigneeController(
    IAddTaskAssigneeService addTaskAssignee,
    IMapper mapper,
    ISaveContextCommand saveCommand) : TaskController
{
    [HttpPut("assignee-add")]
